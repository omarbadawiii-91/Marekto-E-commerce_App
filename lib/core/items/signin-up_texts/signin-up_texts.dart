...
class SigninUpTexts{
  static  Text title = Text("Marketo",style: StyleText.style30,);
    ...
    static  Text subtitle2 = Text("Sign in to your Market account",style: StyleText.style20.copyWith(fontSize: 22.sp),);
    ...
    static Text password = Text("Password",style: StyleText.style16,);
        ...
        static Text forget = Text("Enter your email to reset your password",style: StyleText.style20.copyWith(fontSize: 20.sp));
